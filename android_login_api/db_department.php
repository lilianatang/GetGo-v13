...
// check for empty result
    ...
    // products node
        ...
        // temp user array
            ...
            $course["department_name"] = $row["department_name"];
            $course["average_mark"] = $row["average_mark"];
            $course["description"] = $row["description"];


        // push single product into final response array
            array_push($response["department"], $course);
        }
    // success
        $response["success"] = 1;
...
$courses = new Get_All_Department();
$courses->get_department();
?>