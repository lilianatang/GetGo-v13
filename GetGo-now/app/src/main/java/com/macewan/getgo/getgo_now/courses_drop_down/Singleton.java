...
import static com.macewan.getgo.getgo_now.courses_drop_down.CoursesActivity.*;
import static java.lang.System.load;


/**
 * Author: Siham on 2018-02-17.
 *
...
public class Singleton extends AsyncTask <String,Void, JsonObject>{
    ...
    protected JsonObject doInBackground(String... params) {
        ...
        try {
            URL url = new URL("http://10.55.70.30/GetGo-v13/android_login_api/get_all_courses.php");
        ...
        try {
            ...
            Log.d("Singleton", "INPUT1: " + in.readLine() + con);
